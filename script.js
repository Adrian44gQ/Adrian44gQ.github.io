...
function efectoHablidades(){
    ...
    habilidades[14].classList.add("comunication");
    habilidades[15].classList.add("trabajo");
    habilidades[16].classList.add("creatividad");
    habilidades[17].classList.add("dedicacion");
    habilidades[18].classList.add("liderazgo");
    habilidades[19].classList.add("analitico");
    habilidades[20].classList.add("resolucion");
    habilidades[21].classList.add("adaptacion");
    habilidades[22].classList.add("servicio");
    }
}
